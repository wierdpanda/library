...
<form class="max-w-lg mx-auto">
    <div class="flex">
        ...
        dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-indigo-600 dark:text-white dark:border-gray-600"
    ...
    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
        ...
        <div id="dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
            ...
            <li>
                <button type="button" class="inline-flex w-full px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Authors</button>
            </li>
            <li>
                <button type="button" class="inline-flex w-full px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Genres</button>
            </li>
            <li>
        ...
        <div class="relative w-72">
            <input type="search" id="search-dropdown" class="block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50
                    rounded-e-lg border-s-gray-50 border-s-2 border border-gray-300 focus:ring-blue-500 focus:border-blue-500
                    dark:bg-gray-700 dark:border-s-gray-700  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-indigo-600"
                    placeholder="Search Authors, Genres or Books" required />
            <button type="submit" class="absolute top-0 end-0 p-2.5 text-sm font-medium h-full dark:text-white  rounded-e-lg border dark:border-indigo-600 
                    focus:ring-4 focus:outline-none  dark:bg-indigo-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900">
